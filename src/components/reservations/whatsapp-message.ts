...
export function buildWhatsAppMessage(r: ReservationData, lang: "es" | "en" = "es", onSiteFees?: OnSiteFees): string {
  ...
  if (lang === "en") {
    ...
    lines.push(
      ...
      ``Changes or cancellations must be made at least 72 hours in advance. No refunds on the day of the tour or for no-shows.`, No refunds on the day of the tour or for no-shows.`,
      SEP,
      ``,
  ...
  lines.push(
    ...
    ``Cambios o cancelaciones deben realizarse con 72 hrs de anticipación. No aplica reembolso el mismo día del tour ni por inasistencia.`, No aplica reembolso el mismo día del tour ni por inasistencia.`,
    SEP,
    ``,
    `📲 WhatsApp: +52 56 3974 8122`,
    `📷 Instagram: @walkme_travel`,
